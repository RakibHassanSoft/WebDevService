...
const WebDevelopment = () => {
    return (
        <div className=" bg-[url('https://i.ibb.co/ScTG5H0/fr88395q.png')] bg-fixed bg-opacity-60 text-white font-sans">
            {/* Hero Section */}
            ...
            {/* Image/Video Section */}
            <section className="container mx-auto py-16 px-6 bg-black mt-10">
            ...
            {/* Testimonials */}
            <section className="container mx-auto mt-6 lg:mt-10 lg:p-10 bg-black">
